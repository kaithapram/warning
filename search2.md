...
<br><br><br>
<button class="btn btn-block btn-warning waves-effect waves-light" style="cursor: auto;">Google Search</button>
...
<button class="btn btn-warning mr-sm-2" type="submit" name="sa" value="Search">Search</button>
